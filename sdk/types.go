...
const (
	AgentTitleCustom = "custom" // set by the user with /rename
	AgentTitleAI     = "ai"     // generated by Claude Code for the session
)
...
const (
	...
	AgentCategoryWeb         = "web"
	AgentCategoryDocument    = "document"
	AgentCategoryResearch    = "research"
	AgentCategoryRuntime     = "runtime"
	AgentCategoryData        = "data"
	AgentCategoryGeneral     = "general"
)

// IsAgentCategory reports whether c is one of the AgentCategory* values.
func IsAgentCategory(c string) bool {
	switch c {
	case AgentCategoryDevelopment, AgentCategoryWeb, AgentCategoryDocument, AgentCategoryResearch,
		AgentCategoryRuntime, AgentCategoryData, AgentCategoryGeneral:
		return true
	}
	return false
}
