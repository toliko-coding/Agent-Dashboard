	...
	registry.Register(&mcp.ToolDef{
		...
		InputSchema: map[string]any{
			...
			"properties": map[string]any{
				...
				"autonomy":           map[string]any{"type": "string", "enum": []string{"manual", "spec_gated", "full"}, "description": "Permission gate level: manual=a person approves each permission request (default); spec_gated and full=every tool pre-approved, including shell and file writes, and every request auto-approved (git push stays denied)"},
